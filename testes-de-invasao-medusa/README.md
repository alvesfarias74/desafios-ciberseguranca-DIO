...
![Interface de inicialização do Metasploitable 2](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(1).png)
**
...
![Identificação do endereço IP do alvo](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(3).png)
**

![Validação de conectividade via comando Ping](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(4).png)
**
...
![Resultado da varredura de serviços com Nmap](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(5).png)
**
...
![Falha na tentativa de autenticação manual](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(6).png)
**

![Geração de wordlists para o ataque de força bruta](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(7).png)
**

![Confirmação de acesso bem-sucedido ao serviço FTP](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(8).png)
**
...
![Captura e análise de parâmetros HTTP no navegador](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(12).png)
**

![Execução do Medusa contra o formulário web da DVWA](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(10).png)
**
...
![Início do processo de enumeração de usuários SMB](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(15).png)
**

![Lista de usuários identificados pelo enum4linux](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(17).png)
**

![Ataque de Password Spraying resultando em sucesso](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(19).png)
**

![Visualização dos diretórios compartilhados via SMB](desafios-ciberseguranca-DIO\captura-de-dados\images\img%20(20).png)
**
