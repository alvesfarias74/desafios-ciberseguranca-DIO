...
![Interface de inicialização do Metasploitable 2](./images/img%20(1).png)
**
...
![Resultado da varredura de serviços com Nmap](./images/img%20(5).png)
**
...
![Falha na tentativa de autenticação manual](./images\img%20(6).png)
**

![Geração de wordlists para o ataque de força bruta](./images/img%20(7).png)
**

![Confirmação de acesso bem-sucedido ao serviço FTP](./images/img%20(8).png)
**
...
![Captura e análise de parâmetros HTTP no navegador](./images/\img%20(12).png)
**

![Execução do Medusa contra o formulário web da DVWA](./images/img%20(10).png)
**
...
![Início do processo de enumeração de usuários SMB](./images/img%20(15).png)
**

![Lista de usuários identificados pelo enum4linux](./images/img%20(17).png)
**

![Ataque de Password Spraying resultando em sucesso](./images/img%20(19).png)
**

![Visualização dos diretórios compartilhados via SMB](./images/img%20(20).png)
**
